...
export default {
  ...
  mounted() {
    this.$emit("new-data", this.exerciseName, "reps", this.reps);
    this.$emit("new-data", this.exerciseName, "weight", this.weight);
    this.$emit("new-data", this.exerciseName, "type", this.type);
    this.$emit("new-data", this.exerciseName, "timestamp", this.timestampObj);
  },
  methods: {
  ...
  watch: {
    ...
    weight: function (newVal) {
      this.$emit("new-data", this.exerciseName, "weight", newVal);
    },
    ...
    timestamp: function (newVal) {
      this.$emit("new-data", this.exerciseName, "timestamp", newVal);
    },
  },
};
</script>
